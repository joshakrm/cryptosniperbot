...
pub struct LaunchContext {
    ...
    /// Every other mint the launch transaction touched, so the liquidity check
    /// can test for a burned LP when it cannot name one outright.
    pub other_mints: Vec<String>,
}
